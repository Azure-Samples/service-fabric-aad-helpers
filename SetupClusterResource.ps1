...
.\setupClusterResource.ps1 -tenantId cb4dc457-01c8-40c7-855a-5468ebd5bc74 `
    ...
    -clusterResource '/subscriptions/{{subscriptionId}}/resourcegroups/{{resourcegroup}}/providers/Microsoft.ServiceFabric/clusters/{{clusterName}}'
#>
...
$clusterObj = $global:templateObj.resources | Where-Object type -ieq 'Microsoft.ServiceFabric/clusters'
